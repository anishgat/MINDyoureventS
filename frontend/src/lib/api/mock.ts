...
let mockEvents: EventItem[] = [
  {
    ...
    calendarIconUrl: "/eventIcons/riverCleanup.jpg",
    capacity: 40,
    volunteerQuota: 8,
  ...
  // Same-day (multi-event) example: date matches evt-1001
  {
    ...
    calendarIconUrl: "/eventIcons/picnic.jpg",
    capacity: 50,
    questions: [],
    createdBy: "staff-1",
    createdAt: new Date().toISOString(),
  },
  {
    ...
    calendarIconUrl: "/eventIcons/packathon.jpg",
    capacity: 60,
    volunteerQuota: 12,
  ...
  },
  {
    ...
    calendarIconUrl: "/eventIcons/boardgames.png",
    capacity: 25,
    volunteerQuota: 5,
    questions: [],
    createdBy: "staff-3",
  ...
  // Same-day (multi-event) example: date matches evt-1003
  {
    ...
    calendarIconUrl: "/eventIcons/techShowcase.jpg",
    capacity: 60,
    questions: [],
    createdBy: "staff-3",
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    calendarIconUrl: "/eventIcons/gardenPlanting.jpg",
    capacity: 35,
    volunteerQuota: 7,
    questions: [],
    createdBy: "staff-5",
